		...
		<div className="min-h-screen bg-dark-color text-light-color flex">
			...
			<div className="flex-1 p-8">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
					{/* إضافة Services */}
					<Link to={"/dashboard/services"} className="bg-main-color p-6 rounded-lg shadow-lg">
						<h2 className="text-3xl font-bold mb-4 text-light-color">الخدمات</h2>
						<p className="text-light-color">أضف وأدر خدماتك هنا.</p>
					</Link>

					{/* إضافة Projects */}
					<div className="bg-main-color p-6 rounded-lg shadow-lg">
						<h2 className="text-3xl font-bold mb-4 text-light-color">المشاريع</h2>
