...
const Footer = () => {
	return (
            ...
            hover:-translate-x-1 transition-all"
						>
							<a
								...
								className="hover:text-[var(--main-color)] transition-all flex items-center gap-2"
							>
								<FaMailBulk /> support@www.vortex.com
							</a>
						</li>
						<li
							className="
      ...
      <div className="copyrights">
        <div className="container mt-6 mx-auto w-[90%] border-t-2 border-[var(--main-color)] text-white text-center py-4 hover:scale-105 transition-all">
          &copy; 2025 <span className="text-[var(--main-color)] font-bold">فورتكس</span>. كل الحقوق محفوظة
        </div>
      </div>
		</footer>
	);
